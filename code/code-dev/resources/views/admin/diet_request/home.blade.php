        ...
        <div class="header">
                ...
                <ul>
                    ...
                    @if(kvfj(Auth::user()->permissions, 'diet_request_print_journey'))
                        <li>
                            <a href="#" target="_blank" data-action="impresion_lote" data-path="admin/solicitud_dieta" class="btn-deleted" data-toogle="tooltrip" data-placement="top"><i class="fa-solid fa-file-invoice"></i> Impresión por Lote</a>
                        </li>
                    @endif
