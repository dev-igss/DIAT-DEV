    ...
    @foreach($diet_request as $dr)
        ...
        <body style="font-size: 14px; font-family: 'Roboto Slab', serif;">
                ...
                <div style="float: left; margin-top: 5px; margin-left: 0px; width:300px;height:25px;" >
                    Tiempo de Alimentacion: <input type="text" style="border:1px solid #000000;width:150px; text-align: center; margin-top: 5px; margin-left: 0px;" value="{{ $dr->journey->name }}">
                </div>

                <div style="float: right; margin-top: 5px; margin-right: 50px; width:150px;height:25px;">
                    Fecha: <input type="text" style="border:1px solid #000000;width:150px; text-align: center; margin-top: 5px; margin-left: 0px;" value="{{ \Carbon\Carbon::parse($dr->created_at)->format('d-m-Y')  }}">
                </div>
                ...
                <table width="100%"  style=" margin-top:40px; text-align: center; font-size: 12px;" >
                    ...
                    <TR>
                        ...
                        <TD colspan="2" height="15">
                            @foreach($details as $d)
                                @if($d->iddiet >= 19 && $d->iddiet <= 27 && $d->iddiet_request == $dr->id)
                                    @if($loop->last || $loop->count = 1)
                                        @switch($d->iddiet)
                                            @case(19)
                                                @switch($d->type_pack)
                        ...
                        <TD ROWSPAN="3" colspan="2">
                            @foreach($subtotales_otras as $s)
                                @if($d->iddiet >= 19 && $d->iddiet <= 27 && $s->iddiet_request == $dr->id)
                                    {{ $s->subtotal }}
                                @endif
                            @endforeach
                        </TD>
